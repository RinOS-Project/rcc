...
`test-atomic-builtins`は32-bit整数のload/store/exchange/CAS、fetch add/sub、fenceを
両archで生成・linkし、AMD64生成コードの戻り値、memory更新、複数threadでの原子性を
実行検査します。未実装の64-bit operandはdiagnostic付きで拒否します。
